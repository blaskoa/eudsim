const EduSim = (function init() {
    ...
    let hotspots = [{x:475.477,y:131.703,z:336.91,q:131.703,radius:50, img:'images/wire.png',componentName:'n/a'},{x:336.91,y:131.703,z:336.91,q:128.7,radius:50, img:'images/wire.png',componentName:'n/a'},{x:475.477,y:169.884,z:194.053,q:169.884,radius:50, img:'images/wire.png',componentName:'n/a'},{x:194.053,y:169.884,z:194.053,q:190.476,radius:50, img:'images/wire.png',componentName:'n/a'},{x:302.59,y:128.7,z:194.053,q:128.7,radius:50, img:'images/wire.png',componentName:'n/a'},{x:194.053,y:128.7,z:194.053,q:152.724,radius:50, img:'images/wire.png',componentName:'n/a'},{x:319.75,y:128.7,radius:50, rotate:0, img:'images/accumulator.png' , componentName: '<p><span class="field-title">Voltage </span>10 [V] </p>'},{x:336.91,y:128.7,radius:7, img:'images/connector.png',componentName:'n/a'},{x:302.59,y:128.7,radius:7, img:'images/connector.png',componentName:'n/a'},{x:191.05,y:171.6,radius:50, rotate:0, img:'images/NPNTranzistor.png' , componentName: '<p><span class="field-title">Type </span> NPN </p>'},{x:194.053,y:152.724,radius:7, img:'images/connector.png',componentName:'n/a'},{x:194.053,y:190.476,radius:7, img:'images/connector.png',componentName:'n/a'},{x:469.9,y:150.15,radius:50, rotate:0, img:'images/PNPTranzistor.png' , componentName: '<p><span class="field-title">Type </span>PNP </p>'},{x:475.477,y:131.703,radius:7, img:'images/connector.png',componentName:'n/a'},{x:475.477,y:169.884,radius:7, img:'images/connector.png',componentName:'n/a'},];
