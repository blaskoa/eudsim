const EduSim = (function init() {
    ...
    let hotspots = [{x:245.08,y:224.4,z:245.08,q:224.4,radius:50, img:'images/wire.png',componentName:'n/a'},{x:245.08,y:224.4,z:245.08,q:81.59996,radius:50, img:'images/wire.png',componentName:'n/a'},{x:409.504,y:125.256,z:264.256,q:125.256,radius:50, img:'images/wire.png',componentName:'n/a'},{x:264.256,y:125.256,z:264.256,q:63.64796,radius:50, img:'images/wire.png',componentName:'n/a'},{x:420.52,y:244.8,z:409.504,q:244.8,radius:50, img:'images/wire.png',componentName:'n/a'},{x:409.504,y:244.8,z:409.504,q:161.568,radius:50, img:'images/wire.png',componentName:'n/a'},{x:277.72,y:224.4,z:387.88,q:224.4,radius:50, img:'images/wire.png',componentName:'n/a'},{x:387.88,y:224.4,z:387.88,q:244.8,radius:50, img:'images/wire.png',componentName:'n/a'},{x:404.2,y:244.8,radius:50, rotate:0, img:'images/ZenerDiode.png' , componentName: '<p><span class="field-title">Current </span>0 [A] </p>'},{x:420.52,y:244.8,radius:7, img:'images/connector.png',componentName:'n/a'},{x:387.88,y:244.8,radius:7, img:'images/connector.png',componentName:'n/a'},{x:261.4,y:224.4,radius:50, rotate:0, img:'images/LedDiode.png' , componentName: '<p><span class="field-title">Current </span>0 [A] </p>'},{x:277.72,y:224.4,radius:7, img:'images/connector.png',componentName:'n/a'},{x:245.08,y:224.4,radius:7, img:'images/connector.png',componentName:'n/a'},{x:404.2,y:142.8,radius:50, rotate:0, img:'images/PNPTranzistor.png' , componentName: '<p><span class="field-title">Type </span>PNP </p>'},{x:409.504,y:125.256,radius:7, img:'images/connector.png',componentName:'n/a'},{x:409.504,y:161.568,radius:7, img:'images/connector.png',componentName:'n/a'},{x:387.88,y:142.7999,radius:7, img:'images/connector.png',componentName:'n/a'},{x:261.4,y:81.59996,radius:50, rotate:0, img:'images/bulb.png' , componentName: '<p><span class="field-title">Type </span> NPN </p>'},{x:264.256,y:63.64796,radius:7, img:'images/connector.png',componentName:'n/a'},{x:264.256,y:99.55196,radius:7, img:'images/connector.png',componentName:'n/a'},{x:245.08,y:81.59996,radius:7, img:'images/connector.png',componentName:'n/a'},];
