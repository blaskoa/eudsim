const EduSim = (function init() {
    ...
    let hotspots = [{x:365.34,y:307.6499,z:655.41,q:307.6499,radius:50, img:'images/wire.png',componentName:'n/a'},{x:655.41,y:307.6499,z:655.41,q:351.5999,radius:50, img:'images/wire.png',componentName:'n/a'},{x:585.09,y:351.5999,z:435.66,q:351.5999,radius:50, img:'images/wire.png',componentName:'n/a'},{x:435.66,y:351.5999,z:435.66,q:307.6499,radius:50, img:'images/wire.png',componentName:'n/a'},{x:620.25,y:351.6,radius:50, rotate:0, img:'images/bulb.png' , componentName: '<p><span class="field-title">GUI Lamp </span>Nothing to show [N/A] </p>'},{x:585.09,y:351.6,radius:7, img:'images/connector.png',componentName:'n/a'},{x:655.41,y:351.6,radius:7, img:'images/connector.png',componentName:'n/a'},{x:400.5,y:307.65,radius:50, rotate:0, img:'images/accumulator.png' , componentName: '<p><span class="field-title">Voltage </span>10 [V] </p>'},{x:435.66,y:307.65,radius:7, img:'images/connector.png',componentName:'n/a'},{x:365.34,y:307.65,radius:7, img:'images/connector.png',componentName:'n/a'},];
