const EduSim = (function init() {
    ...
    let hotspots = [{x:671.65,y:409.0499,radius:50, rotate:0, img:'images/capacitor.png' , componentName: '<p><span class="field-title">Capacitance </span>50 [uF] </p>'},{x:708.01,y:409.0499,radius:7, img:'images/connector.png',componentName:'n/a'},{x:635.29,y:409.0499,radius:7, img:'images/connector.png',componentName:'n/a'},{x:580.75,y:318.1499,radius:50, rotate:0, img:'images/bulb.png' , componentName: '<p><span class="field-title">GUI Lamp </span>Nothing to show [N/A] </p>'},{x:544.39,y:318.1499,radius:7, img:'images/connector.png',componentName:'n/a'},{x:617.11,y:318.1499,radius:7, img:'images/connector.png',componentName:'n/a'},];
